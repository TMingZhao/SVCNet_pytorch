...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_weights', type=str, default='pretrained/pretrained_model.pth', help='pretrain models file')  # 416
    parser.add_argument('--iteration', type=int, default=3, help='pretrain models file')  # 416
    ...
    if args.task == "denoise":
        denoisingX(args.iteration, net, args.ply_path, DENOISE.mini_point, device, args.batch_size, intermediate=False)
    elif args.task == "upsample":
        upsamplingX(args.up_ratio, args.iteration, net, args.ply_path, DENOISE.mini_point, device, args.batch_size, intermediate=False)
